...
(function ($) {
  ...
  $container.append('<h6>Opciones del Pie de Página</h6>');
  ...
  $sidebar_dark_variants.removeClass().addClass('custom-select mb-3 text-light border-0 ').addClass(active_sidebar_dark_color)
   ...
   $container.append('<h6>Variantes de Barra Lateral Clara</h6>');
 ...
 $container.append('<h6>Variantes de Logotipo de Marca</h6>');
