...
<div class="wrapper">
  ...
  <div class="preloader flex-column justify-content-center align-items-center">
    <img class="animation__shake" src="<?php echo $this->assets; ?>img/logo.jpg" alt="Logo" height="60" width="60">
  </div>
  ...
  <div class="content-wrapper">
    ...
    <?php
      $this->ContentHeader([
          'titulo' => 'Torres Music',  
          'links' => [
            ['label' => 'Torres Music', 'url' => '#','active' => true],
            ['label' => 'Inicio', 'url' => '#'],
          ],
      ])->view();
    ?>
