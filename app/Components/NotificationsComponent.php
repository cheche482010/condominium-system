...
class NotificationsComponent extends Component
{
    ...
    public function view()
    {
        ...
        foreach ($this->notifications as $notification) {
            echo "\t\t\t\t\t<a href=\"" . htmlspecialchars($notification['link']) . "\" class=\"dropdown-item\">\n";
            echo "\t\t\t\t\t\t<i class=\"" . htmlspecialchars($notification['icon']) . " mr-2\"></i>" . htmlspecialchars($notification['text']);
            echo "\t\t\t<span class=\"float-right text-muted text-sm\">" . htmlspecialchars($notification['timestamp']) . "</span>\n";
            echo "\t\t\t\t\t</a>\n";
            echo "\t\t\t\t\t<div class=\"dropdown-divider\"></div>\n";
        }
